    ...
    <>
      <div className={cx("wrapper")}>
        ...
        >
          ...
          <g id={cx("fortyfour")} data-name="Layer 2">
            <g className={cx("four", "a")}>
              <rect
                className={cx("cls-2")}
                x="233.74"
                y="391.14"
          ...
          <g id={cx("umbrella")} data-name="Layer 3">
            <g>
              <circle
                className={cx("cls-4")}
                cx="1187.53"
          ...
          <g id={cx("pillow")} data-name="Layer 4">
            <path
              className={cx("cls-1")}
          ...
          <g id={cx("clock")} data-name="Layer 8">
            <circle
              className={cx("cls-5")}
              cx="847.7"
              cy="247.59"
            ...
            />
            <rect
              className={cx("cls-3", "clock-hand-1")}
              x={845}
              y="189.5"
              width="6.04"
              height={58}
            ...
            />
            <rect
              className={cx("cls-3", "clock-hand-2")}
              x={845}
              y="209.5"
              width="6.04"
              height={38}
          ...
          <g id={cx("rucksack")} data-name="Layer 6">
            <g id={cx("stripe")}>
              <path
                className={cx("cls-12")}
          ...
          <g id={cx("bike")} data-name="Layer 5">
            <path
              className={cx("cls-8", "wheel")}
      ...
      <h1 className={cx("message-wrapper")}>Oops! Trang này không tồn tại.</h1>
      <div className="text-center m-4">
        <Link to={"/"} className={cx("btn-wrapper")}>
          Quay về trang chủ
        </Link>
      </div>
    </>
